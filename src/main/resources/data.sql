...
INSERT INTO GLUCOSEMEASUREMENT (GLUCOSEVALUE, USERID, MEASUREDATE, COMMENT) VALUES (5.4, 1, parsedatetime('13-08-2016 14:40', 'dd-MM-yyyy hh:mm'), 'test comment');
...
INSERT INTO GLUCOSEMEASUREMENT (GLUCOSEVALUE, USERID, MEASUREDATE) VALUES (5.9, 1, parsedatetime('12-09-2016 06:45', 'dd-MM-yyyy hh:mm'));
INSERT INTO GLUCOSEMEASUREMENT (GLUCOSEVALUE, USERID, MEASUREDATE) VALUES (8.7, 1, parsedatetime('12-09-2016 12:45', 'dd-MM-yyyy hh:mm'));
INSERT INTO GLUCOSEMEASUREMENT (GLUCOSEVALUE, USERID, MEASUREDATE) VALUES (10.6, 1, parsedatetime('12-09-2016 20:45', 'dd-MM-yyyy hh:mm'));

INSERT INTO GLUCOSEMEASUREMENT (GLUCOSEVALUE, USERID, MEASUREDATE) VALUES (5.2, 1, parsedatetime('13-09-2016 06:35', 'dd-MM-yyyy hh:mm'));
INSERT INTO GLUCOSEMEASUREMENT (GLUCOSEVALUE, USERID, MEASUREDATE) VALUES (9.8, 1, parsedatetime('13-09-2016 14:45', 'dd-MM-yyyy hh:mm'));
INSERT INTO GLUCOSEMEASUREMENT (GLUCOSEVALUE, USERID, MEASUREDATE) VALUES (7.9, 1, parsedatetime('13-09-2016 21:00', 'dd-MM-yyyy hh:mm'));

INSERT INTO GLUCOSEMEASUREMENT (GLUCOSEVALUE, USERID, MEASUREDATE) VALUES (5.7, 1, parsedatetime('14-09-2016 06:40', 'dd-MM-yyyy hh:mm'));
INSERT INTO GLUCOSEMEASUREMENT (GLUCOSEVALUE, USERID, MEASUREDATE) VALUES (10.6, 1, parsedatetime('14-09-2016 13:30', 'dd-MM-yyyy hh:mm'));
INSERT INTO GLUCOSEMEASUREMENT (GLUCOSEVALUE, USERID, MEASUREDATE) VALUES (8.7, 1, parsedatetime('14-09-2016 21:45', 'dd-MM-yyyy hh:mm'));
